...
<body>
    ...
    <div class="tools">
		...
		<li style="float:right">
			...
			<strong>&nbsp;&nbsp;&nbsp;搜索关键字：</strong>
			<input name="title" type="text" id="title" size="20" maxlength="50" class="dfinput" style="width:200px;height:28px" placeholder="代理登录名"/>
    ...
    <tr height="35px">
		...
		<td><?=$row['username']?></td>
		<td><?=$row['kehushu']?></td>
		<td><?=$rowcc['ccc']?>&nbsp;<?php if($rowcc['ccc']>0){?><a href="userlist.php?act=search&title=<?=$row['username']?>" class="tablelink"></a><?php } ?></td>
