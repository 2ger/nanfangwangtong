...
if($_GET["act"]=="del")
{
	 $sql="delete from tbl_user_group where id=".$_GET['id'];
	 mysql_query($sql);
	 mysql_close();
	 echo "<script type='text/javascript'>alert('成功删除!');location.href='group.php';</script>";
	 exit;
}
...
<div class="overlay"></div>
    ...
    <div class="tools">
    	<ul class="toolbar">
        <li class="click"><a href="groupedit.php"><span><img src="images/t01.png" /></span>添加会员组</a></li>
	...
	$page_sql = "select * from tbl_user_group";
	qy_page($page_sql,20);
	$sql = "select * from tbl_user_group ORDER by id DESC LIMIT $_pagenum,$_pagesize";
    ...
    <tr height="35px">
		...
		<td><a href="groupedit.php?id=<?=$row['id']?>" class="tablelink">编辑</a>     <a href="group.php?id=<?=$row['id']?>&act=del" onclick="if (confirm('确定要删除吗？')) return true; else return false;" class="tablelink"> 删除</a></td>
    </tr>
    <?php
	}
	?>    
