...
<dl class="leftmenu">
  ...
  <?php 
		...
		echo '<dd><div class="title"><span><img src="images/leftico01.png" /></span>用户管理</div><ul class="menuson"><!--<li><cite></cite><a href="admindit.php" target="rightFrame">添加代理</a><i></i></li> <li><cite></cite><a href="adminlist.php" target="rightFrame">代理列表</a><i></i></li>-->
		 <li><cite></cite><a href="guserlist.php" target="rightFrame">用户列表</a><i></i></li> <!--<li><cite></cite><a href="gartile.php" target="rightFrame">总文章列表</a><i></i></li>--> <li><cite></cite><a href="group.php" target="rightFrame">会员组管理</a><i></i></li>
                 <li><cite></cite><a href="bank.php" target="rightFrame">银行卡管理</a><i></i></li>
</ul></dd>';
                echo '<dd><div class="title"><span><img src="images/leftico01.png" /></span>财务管理</div>
		<ul class="menuson"><li><cite></cite><a href="tixian.php" target="rightFrame">提现管理</a><i></i></li> 
                <li><cite></cite><a href="chongzhi.php" target="rightFrame">充值管理</a><i></i></li> 
                <li><cite></cite><a href="account_log.php" target="rightFrame">交易日志</a><i></i></li> 
		 </ul></dd>';
...
//			}
  ...
  <?php 
		  ...
		  echo '<dd>
			...
			<ul class="menuson">
				<li>
					<cite></cite><a href="adlist.php" target="rightFrame">广告列表</a>
				</li>
