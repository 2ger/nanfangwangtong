...
@$imagesrand=rand(1000000000,9999999999);
if($type==1){
$appimagename="zfb.png";
$typename="支付宝扫码";
$picurlewm= "HTTPS://QR.ALIPAY.COM/xxxxxxxxxxxxxxxxx";  //通用支付宝二维码地址
$picurlfx="tyali.jpg?rand=".@$imagesrand;
$ewmmaxn=$cny.".09";
}
if($type==2){
$appimagename="qqqianbao.jpg";
$typename="QQ钱包扫码";
$picurlewm= "tyten.jpg?rand=".@$imagesrand;  //通用QQ二维码地址
$picurlfx="tyten.jpg?rand=".@$imagesrand;
$ewmmaxn=$cny.".09";
}
if($type==3){
$appimagename="wx.png";
$typename="微信扫码";
$picurlewm= "tywx.jpg?rand=".@$imagesrand;  //通用微信二维码地址
$picurlfx="tywx.jpg?rand=".@$imagesrand;
$ewmmaxn=$cny.".09";
}
		  ...
		  <?php } ?>
            ...
            <div class="row">
              <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-xs-12 paypage-qrrow">
                <?php if($type==3){ ?><p id="paypage-tip"><b>微信</b>保存二维码到手机相册打开微信扫一扫识别截图进行支付
</p><?php } ?>
    ...
    <div class="page animsition text-center" style="-webkit-animation: 800ms; opacity: 1;">
      <div class="page-content vertical-align-middle">
          ...
          <div id="pjax" class="container">
            ...
            <div class="row">
              <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-xs-12 paypage-qrrow">
                <?php if($type==3){ ?><p id="paypage-tip"><font color="#CC0000" style=" font-size:14px;">长按识别二维码图片，选择识别图中二维码支付成功后自动跳转</font></p><?php } ?>
				<?php if($type==1){ ?><p id="paypage-tip"><a href="<?php echo $_SESSION['ewmurl']; ?>">支付宝APP如果没有自动跳转可尝试点击此处进行跳转支付</a></p><?php } ?>
				<?php if($type==2){ ?><p id="paypage-tip">QQ钱包支付可保存二维码到手机相册打开QQ进行扫一扫识别</p><?php } ?>
